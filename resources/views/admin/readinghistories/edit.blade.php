...
<div class="container py-4">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-4">
            ...
            {{-- 🔴 ROUTE SUDAH BENAR --}}
            <form action="{{ route('admin.kelolariwayat.update', $history->id) }}"
                  method="POST" enctype="multipart/form-data">
                @csrf
                {{-- ❌ JANGAN PUT, ROUTE UPDATE KAMU PAKAI POST --}}
                ...
                <div class="mb-3">
                    ...
                    <input type="date"
                           class="form-control"
                           name="last_read_at"
                           value="{{ \Carbon\Carbon::parse($history->last_read_at)->format('Y-m-d') }}">
                </div>
