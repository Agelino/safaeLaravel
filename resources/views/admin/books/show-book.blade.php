            ...
            <div class="card-body p-4">
                <div class="row">
                    ...
                    <div class="col-md-4 text-center mb-4 mb-md-0">
                        ...
                        @else
                            <div class="bg-light d-flex align-items-center justify-content-center book-cover-detail" style="height: 400px; margin: 0 auto;">
                        ...
                        <div class="mt-4">
                            <span class="badge bg-primary fs-6 px-3 py-2">{{ $book->genre }}</span>
                            <div class="mt-3">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="meta-info mb-4 border-bottom pb-3">
                            <span class="me-3"><i class="fas fa-user me-1"></i> Penulis: <strong>{{ $book->author }}</strong></span>
                            <span class="me-3"><i class="fas fa-calendar me-1"></i> Tahun: <strong>{{ $book->year }}</strong></span>
                            <span><i class="fas fa-clock me-1"></i> Diupdate: {{ $book->updated_at->format('d M Y') }}</span>
                        </div>
